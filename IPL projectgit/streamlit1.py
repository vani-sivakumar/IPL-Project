...
st.markdown("<h1 style='text-align: center; color: #ebeb34;'> IPL Score Predictor </h1>", unsafe_allow_html=True)
...
with st.expander("Description"):
    st.markdown('<p style="color: #ebeb34;">A Simple ML Model to predict IPL Scores between teams in an ongoing match. To make sure the model results accurate score and some reliability the minimum no. of current overs considered is greater than 5 overs.</p>', unsafe_allow_html=True)
